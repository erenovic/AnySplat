    ...
    def forward(self, x):
        ...
        if self.use_flashatt_v2:
            ...
            x = xops.memory_efficient_attention(
                q, k, v, op=(xops.fmha.flash.FwOp, xops.fmha.flash.BwOp), p=self.attn_drop_p
            )
...
class TransformerBlockSelfAttn(nn.Module):
    def __init__(
        ...
        self.mlp = Mlp(
            in_features=dim, mlp_ratio=mlp_ratio, mlp_bias=mlp_bias, act_layer=act_layer, drop=drop
        )
