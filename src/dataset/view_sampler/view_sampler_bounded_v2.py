"""
From `depthSplat` repository: https://github.com/cvg/depthsplat
...
class ViewSamplerBoundedV2Cfg:
    ...
    extra_views_sampling_strategy: Literal["random", "farthest_point", "equal"] | None = "random"
    target_views_replace_sample: bool | None = True
